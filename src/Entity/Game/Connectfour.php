...
class Connectfour extends Game
{
     ...
     * @var string
     */
    protected static $description = 'Connect Four هي لعبة اتصال يتناوب فيها اللاعبون على إسقاط الأقراص الملونة من الأعلى إلى شبكة معلقة رأسيًا مكونة من سبعة أعمدة وستة صفوف';
